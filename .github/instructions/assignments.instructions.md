...
This folder contains guidance for creating and organizing new homework assignments within the repository.

- Use the template located at `templates/assignment-template.md` when adding new assignments. 
- Each assignment should have a descriptive `README.md` in its own subdirectory under `assignments/`.
- Include any starter code, data files, or supporting materials alongside the README.

Feel free to update these instructions with more policies as needed.
